...
# keywords to find the lines we are looking for in the log file
	...
	dirpath = os.getcwd()
	path = dirpath+'/json_trace_folder_not_comp'
...
# initialize the trace with the zero tuple
	...
	# instead if for some reason the robot don't reach the kicthen the trace is indicate ad trace_f 
		...
		print("Conversion finished, you can find your traces in the json_trace_folder_not_comp")
...
######################################################### sample generation #############################################################################################
		...
		time.sleep(1)
		outfilename = "sample_notComp.json"
